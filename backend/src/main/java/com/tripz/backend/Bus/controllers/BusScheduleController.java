...
public class BusScheduleController {
    ...
    @PutMapping("/{id}")
    public BusScheduleDTO updateBusSchedule(@PathVariable Integer id, @RequestBody BusScheduleCreateRequestDTO request){
        return busScheduleService.updateBusSchedule(id, request);
    }
}
